...
public class WorkWidget2x1Provider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int id) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_work_2x1);
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, 104, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
